export const prodRoutes = [{
        ...
        component: () =>
            import ("pages/PageSuaKeHoachTheoMaThiTruong.vue")
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("pages/PageBaoCaoThucHienSanXuat.vue")
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("pages/PageBaoCaoCapPhoiSanXuat.vue")
    },
    {
        path: "/Factories-Plan",
        component: () =>
    ...
    },
    {
        path: "/he-so-lua-phoi",
        component: () =>
            import ("pages/KeHoach/PageHeSoCapPhoiLuaPhoi.vue")
    },
    {
        path: "/ke-hoach",
        component: () =>
            import ("pages/KeHoach/PageKeHoach.vue")
    },
    {
        path: "/report-detail-success",
        component: () =>
            import ("pages/Reports/Prod/ReportDetailPro.vue")
    },
    {
        path: "/bang-gia-tinh-luong",
        component: () =>
            import ("pages/MasterData/PageMarketPrice.vue")
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("pages/Reports/Prod/ResultDate.vue")
    },
    {
        path: "/report-prod-result-month",
        component: () =>
            import ("pages/Reports/Prod/ResultMonth.vue")
    },
    {
        path: "/report-prod-result-detail",
        component: () =>
            import ("pages/Reports/Prod/ResultDetail.vue")
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("pages/Reports/Prod/ResultLSX.vue")
    },
    {
        path: "/report-prod-qc-luaphoi",
        component: () =>
            import ("pages/Reports/Prod/QCxLuaPhoi.vue")
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("pages/Reports/Prod/Week3.vue")
    },
    {
        path: "/report-prod-truy-nguyen",
        component: () =>
            import ("pages/Reports/Prod/TruyNguyen.vue")
    },

    {
        path: "/tool-prod-create-package",
        component: () =>
            import ("pages/Tools/CreatePackage.vue")
    },

    {
        path: "/bao-cao-cho-say",
        component: () =>
            import ("pages/Reports/Prod/BaoCaoChoSay.vue")
    },
...

    {
        ...
        component: () =>
            import ("pages/KH/ViewKeHoach.vue"),
        meta: {
            requiresAuth: true
        }
    },
    ...
    //     component: () =>
    //         import ("pages/KH/DinhMucTon.vue"),
    //     meta: {
    //         requiresAuth: true
    //     }
    // },
    {
        path: "/kh-report-kh",
        component: () =>
            import ("pages/Reports/Prod/KeHoachVaThucHien.vue"),
        meta: {
            requiresAuth: true
        }
    },
    ...
    },
    {
        ...
        component: () =>
            import ("pages/BCSanLuongByDay.vue"),
        meta: {
            requiresAuth: true
        }
    },
    ...
    //     component: () =>
    //         import ("pages/DinhMucNguyenVatLieu.vue"),
    //     meta: {
    //         requiresAuth: true
    //     }
    // },
