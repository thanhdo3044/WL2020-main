...
const api = {
    ...
    PROD_REPORT_WEEK: BASE_URL + "/bao-cao-raw-data/week",
    PROD_REPORT_WEEK2: BASE_URL + "/bao-cao-raw-data/week2",
    PROD_REPORT_WEEK3: BASE_URL + "/bao-cao-raw-data/week3",
    PROD_REPORT_WEEKIN: BASE_URL + "/bao-cao-raw-data/weekin",
    PROD_REPORT_WEEK4: BASE_URL + "/bao-cao-raw-data/week4",
    PROD_REPORT_LSX: BASE_URL + "/bao-cao-raw-data/lsxchuaduyet",
    PROD_REPORT_WEEKDEPARTMENT: BASE_URL + "/bao-cao-raw-data/WEEKDEPARTMENT",
    PROD_REPORT_SON: BASE_URL + "/bao-cao-raw-data/ton-son",
    PROD_REPORT_LUONG: BASE_URL + "/bao-cao-raw-data/luong",
    ...
    PROD_MACHINE: BASE_URL + "/machine",
    PROD_SAN_LUONG_MAY: BASE_URL + "/machine/san-luong-may",
    ...
    NLG_CHU_RUNG: BASE_URL + "/chu-rung",
    NLG_MA_LO_GO: BASE_URL + "/ma-lo-go",
    ...
    NLG_HE_SO: BASE_URL + "/nlg-he-so-cap-go",
    NLG_KE_HOACH_TUAN: BASE_URL + "/ke-hoach-tuan",
