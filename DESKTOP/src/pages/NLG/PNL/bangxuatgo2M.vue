    ...
    <q-card class="my-card">
      <table id="tableHead" width="100%">
        <thead class="w-100">
          ...
          <tr>
            <th colspan="4">
              <strong> PHIẾU XUẤT NGUYÊN VẬT LIỆU </strong>
            </th>
          </tr>
          <tr></tr>
      ...
      <q-card class="my-card">
        ...
        >
          ...
          <DxColumn
            ...
            css-class="mauBXG2M"
          />
          <DxColumn data-field="DAY" caption="Dày" width="60" css-class="mauBXG2M" />
          <DxColumn
            data-field="RONG"
            caption="Rộng"
            width="60"
            css-class="mauBXG2M"
          />
          <DxColumn data-field="DAI" caption="Dài" width="60" css-class="mauBXG2M" />
