<template>
  ...
  <q-page class="q-pa-md">
    <q-banner class="text-primary">
      ...
      <div class="text-h6 q-mt-lg">Tạo phiếu chỉ định BTP - {{ idDepartment.label }}</div>
    </q-banner>
<div class="row">
          <q-select
            class="col-2 q-ml-sm"
            ...
            />
             <DxColumn
                ...
                caption="Hệ số"
                 alignment="center"
                  width="100"
                  :calculate-cell-value="calculateHESO"
            />
             <DxColumn
                data-field="klc"
                caption="SL cấp"
    ...
    methods:{
        ...
        number: this.number,
         factoryId: this.fa,
           ...
           const data = await this.$store.dispatch('nlg/GET_HE_SO_CAP_GO_TP',payload)
