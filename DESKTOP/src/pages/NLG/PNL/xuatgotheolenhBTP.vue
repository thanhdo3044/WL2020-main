...
<div class="row print-hide" >
          ...
          <q-select class="col-2 q-mb-sm q-ml-sm" @input="changeDepartment" outlined v-model="department" :options="departments" label="Chọn công đoạn" />
...
export default {
  ...
  data() {
    return {
      ...
      dongsanpham: [
        {
          label: "3.1 VGT (Indoor) - X3 (TH)",
          id: 100278,
        },
        {
          label: "4.Tinh chế 1 - X1 (TH)",
          id: 100266,
        },
        {
          label: "4.Tinh chế 2 - X1 (TH)",
          id: 100267,
        },
        {
          label: "4.Tinh chế 1 - X3 (TH)",
          id: 100280,
        },
        {
          label: "4.Tinh chế 2 - X3 (TH)",
          id: 100281,
        },
        {
        ...
        {
          label: "Nhà máy CBG Thuận Hưng (TH)",
          id: 100000,
        },
      ],
      options: [
  ...
  methods: {
    ...
    async xoa() {
      let capgo = [];
      this.historys.forEach((d) => {
        if (d.THANH > 0 || d.TonTH > 0) capgo.push(d);
      });
      this.dulieu = capgo;

      const payload = {
        number: this.number,
        SOURCE_ID: this.department.value,
        week: this.week,
        year: this.year,
        XUATNHAP: "xuat",
