    ...
    <div>
      <div class="row" style="background-color: #daf8e1">
        <div class="col-6 text-blue text-bold" style="font-size: 18px">
          Chọn công đoạn và sản phẩm yêu cầu QC xác nhận khi giao nhận
        </div>
      </div>
    </div>
    <q-card>
      <div style="padding: 5px">
        <div class="row bg-grey-1" style="padding: 5px 0 5px 0">
          ...
          <!-- <div class="col-2">
            <button type="button" style="border: none" class="bg-positive text-white" @click="capnhat">Cập nhật xác nhận QC</button>
          </div> -->
        ...
        >
          ...
          <DxColumn
            data-field="xacnhanqc"
            caption="Cập nhật xác nhận QC"
  ...
  methods: {
    ...
    async rowUpdating(e) {
      ...
      const { newData, oldData } = e;
       const payload = {
        ID:oldData.ID,
        xacnhanqc: newData.xacnhanqc,
      };
      const data = await this.$store.dispatch("prod/updatexacnhanqc", payload);
    ...
    async loadData() {
      ...
      this.dataSource = await this.getXacNhanQC({
