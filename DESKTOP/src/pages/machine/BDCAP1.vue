  ...
  <q-page class="q-pa-sm">
    ...
    <q-card>
      ...
      >
        ...
        />
           <DxColumn
          data-field="CACH_KIEM_TRA"
          caption="Cách kiểm tra"
          :width="120"
          cssClass="kiemtramay"
        />
      <DxColumn
  ...
  methods: {
    ...
    async load() {
      ...
      const data = await this.$store.dispatch(
        "machine/GET_REPORT_BAO_DUONG_CAP_1",
        payload
      );
        const data2 = await this.$store.dispatch(
        "machine/GET_REPORT_BAO_DUONG_CAP_1_LOI",
        payload
      );
        const data1 = await this.$store.dispatch(
        "machine/GET_REPORT_BAO_DUONG_CAP_1_DAT",
        payload
      );
