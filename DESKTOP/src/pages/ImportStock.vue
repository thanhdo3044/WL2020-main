  ...
  <q-page>
    <q-banner class="bg-primary text-orange">
      <div class="text-h6 orange">
        <span color="orange">Nhập xuất tồn Kho thành phẩm</span>
      </div>
    </q-banner>
    <div>
...
export default {
  ...
  data() {
    return {
      columns: [
        { label: "Ngày tháng", field: "created" },
        {
          name: "ACCOUNT",
          required: true,
          label: "Tên sản phẩm",
        ...
        { name: "length", label: "Số lượng", field: "quantity" },
        { name: "date_of_birth", label: "Pallet full", field: "palletFull" },
        { name: "gender", label: "Pallet Top 1", field: "palletTop1" },
        { name: "domicile", label: "Pallet Top 2", field: "palletTop2" },
        { name: "ADDRESS1", label: "Ghi chú", field: "description" },
        { name: "ADDRESS3", label: "Nguồn phôi", field: "nguonPhoi" },
        { label: "Nghiệp vụ", field: "major" },
        { label: "Số phiếu", field: "votes" },
          ...
          await results.forEach((e) => {
            if (e.MAJOR === "N") {
              this.resultData.push({
                departmentId: 100071,
                name: e.NAME ? e.NAME : null,
                market_code: e.CODE ? e.CODE : null,
                quantity: e.QUANTITY ? e.QUANTITY.split(",").join("") : 0,
                palletFull: e.PALLET_FULL ? e.PALLET_FULL : 0,
                palletTop1: e.PALLET_TOP1 ? e.PALLET_TOP1 : 0,
                palletTop2: e.PALLET_TOP2 ? e.PALLET_TOP2 : 0,
                description: e.DESCRIPTION ? e.DESCRIPTION : null,
                ...
                major: e.MAJOR ? e.MAJOR : null,
                votes: e.VOTES ? e.VOTES : null,
