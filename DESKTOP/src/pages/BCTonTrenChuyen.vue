      ...
      <div v-if="factory1" class="col-12">
        ...
        >
          ...
          >
              ...
              width="100"
              format="#,##0.##"
               :calculate-cell-value="calculateTongtonDK"
            />
             <DxColumn
              data-field="tongnhapYS"
              caption="Tổng nhập YS"
              data-type="number"
              alignment="center"
              :allowEditing="true"
              cssClass="ColorDG tonDauKy"
              width="100"
              format="#,##0.##"
               :calculate-cell-value="calculateTongYS"
            />
               <DxColumn
              data-field="tongnhapTB"
              caption="Tổng nhập TB"
              data-type="number"
              alignment="center"
              :allowEditing="true"
              cssClass="ColorDG tonDauKy"
              width="100"
              format="#,##0.##"
               :calculate-cell-value="calculateTongTB"
            />
               <DxColumn
              data-field="tongtonCK"
              caption="Tồn cuối kỳ (M3)"
              data-type="number"
              alignment="center"
              :allowEditing="true"
              cssClass="ColorDG tonDauKy"
              width="100"
              format="#,##0.##"
               :calculate-cell-value="calculateTongtonCK"
            />
              <DxColumn
              data-field="tongCKSL"
              caption="Tồn cuối kỳ (SL)"
              ...
              width="100"
              format="#,##0.##"
               :calculate-cell-value="calculateTongtonSL"
            />
            </DxColumn>
...
export default {
 ...
 calculateTongM3_TC(e) {
  e.tonckM_TCM = roundNumber(e.tonckM_TC/(e.VOLUMN),0)
    return  e.tonckM_TCM;
 },
    ...
    // },
     calculateTongM3_S(e) {
  e.tonckM_SM = roundNumber(e.tonckM_S/(e.VOLUMN),0)
    return  e.tonckM_SM;
 },
    //  calculateTongDB_S(h) {
    //   let mindg = 10000000;
  ...
  e.tonckM_DGM = roundNumber(e.tonckM_DG/(e.VOLUMN),0)
    return  e.tonckM_DGM;
 },
 calculateTongtonSL(e){
  e.tongCKSL = roundNumber((e.tonckM_TC + e.tonckM_S +e.tonckM_DG)/e.VOLUMN,0)
  return e.tongCKSL;
 },
 calculateTongtonDK(e) {
  e.tongtonDK = e.tondkM_TC + e.tondkM_S +e.tondkM_DG
   return  e.tongtonDK;
 },
  calculateTongtonCK(e) {
  e.tongtonCK = e.tonckM_TC + e.tonckM_S +e.tonckM_DG
   return  e.tongtonCK;
 },
  calculateTongYS(e) {
  e.tongnhapYS = e.nhapYSM_TC + e.nhapYSM_S +e.nhapYSM_DG
   return  e.tongnhapYS;
 },
  calculateTongTB(e) {
  e.tongnhapTB = e.nhapTBM_TC + e.nhapTBM_S +e.nhapTBM_DG
   return  e.tongnhapTB;
 },
    ...
    async selectAll() {
     ...
     this.khoiluongsp = 0
        ...
        if (options.summaryProcess === "calculate") {
         ...
         if (options.name === "tongSL") {
        if (options.summaryProcess === "start") {
     this.tongSLSP = 0
        }
        if (options.summaryProcess === "calculate") {

               this.tongSLSP += roundNumber((options.value.tonckM_TC + options.value.tonckM_S +options.value.tonckM_DG)/options.value.klsp,0)
          
          options.totalValue = this.tongSLSP
          
        }
      }
         if (options.name === "maKT") {
        if (options.summaryProcess === "start") {
    // this.makt1 = null
        }
        if (options.summaryProcess === "calculate") {
       
          //     this.makt1 = options.value.makt
          
          options.totalValue =  options.value.makt
