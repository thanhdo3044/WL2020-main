<template>
  <q-page>
    ...
    <q-card class="my-card">
      <DeNghiDiCongTac :order="order"  :metaValue="metaValue" :disable="disable"></DeNghiDiCongTac>
    </q-card>
...
import DeNghiDiCongTac from "components/eof/DeNghiDiCongTac.vue";
export default {
  data() {
    return {
      disable: false,
      metaValue: {
        kinhGui: "Ban TGĐ - Phòng nhân sự :",
        noiDungTT: "",
        soTien: 0,
        vietBangChu: "",
        kemTheo: "",
