  ...
  <q-page>
    <q-banner class="bg-primary text-orange">
      <div class="text-h6 orange">
        <span color="orange">Import tài khoản mới</span>
      </div>
    </q-banner>
    <div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: "length1", label: "Chức vụ", field: "position" },
        { name: "lengtưeh1", label: "Phòng ban", field: "departmentId" },

        { name: "length2", label: "Tạo bởi", field: "createBy" },
    ...
    async onClick() {
      if (this.selected) {
        if (this.resultData.length > 0) {
          let result = [];
          let IMPORT_TON_DAU_KY = this.IMPORT_ACCOUNTS;
          ...
          await results.forEach((e) => {
            if (e.account) {
              this.resultData.push({
                ...
                createBy: e.createBy ? e.createBy : null,
                password: '$2b$10$hG7xMLNEWF2/JJrPBmLjB.MMVy3dp2xQUxPRuGYxG4eghEs./NxB2'
              });
            }
          });
