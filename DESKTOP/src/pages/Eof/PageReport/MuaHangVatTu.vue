  ...
  <q-page>
    <!-- <q-page-sticky expand position="top">
      <q-toolbar class="bg-primary text-orange q-pa-sm">
        <q-toolbar-title>Danh sách đề xuất đã hoàn thành phê duyệt</q-toolbar-title>
      </q-toolbar>
    </q-page-sticky>
    <div class="q-mt-xl row">
      ...
      <div class="q-pa-md col" style="max-width: 300px">
        <q-input filled v-model="dateStart" fill-mask mask="####-##-## ##:##" label="Thời gian từ">
      ...
      <div class="q-pa-md col" style="max-width: 300px" >
        <q-input filled v-model="dateEnd" fill-mask mask="####-##-## ##:##" label="Thời gian đến">
          <template v-slot:append>
            <q-icon name="event" class="cursor-pointer">
              <q-popup-proxy
                ref="qDateProxy"
                ...
                transition-hide="scale"
              >
                <q-date @input="searchData" mask="YYYY-MM-DD HH:mm" v-model="dateEnd">
                  <div class="row items-center justify-end">
                    <q-btn v-close-popup label="Close" color="primary" flat />
                  </div>
                </q-date>
    ...
    <div>
      <div class="row" style="background-color: #daf8e1">
        <div class="col-6 text-blue text-bold" style="font-size: 18px">
          Danh sách đề xuất đã hoàn thành
    ...
    >
      ...
      <DxColumn
        ...
        caption="NV Đề xuất"
      />
      <DxColumn :width="100" data-field="Department.name" caption="Phòng ban" />
      <DxColumn
        :width="200"
        data-field="status"
      ...
      <DxColumn
        :width="150"
        :allow-sorting="false"
        data-field="timeSuccess"
        cell-template="cellTemplateTimeSuccess"
        caption="Thời gian xác nhận HT"
      />
      <DxColumn
        :width="150"
        :allow-sorting="true"
        data-field="nameSuccess"
        caption="Người xác nhận HT"
      />
      <!-- <DxColumn
        :width="150"
        :allow-sorting="false"
      ...
      <template #cellTemplateSuccess="{ data }">
        <a>
          {{ data.value == 1 ? "Đã hoàn thành" : "Chưa hoàn thành" }}
        </a>
      </template>
      <template #cellTemplateTimeSuccess="{ data }">
        <a>
          {{
            moment(data.value).format("l") +
            " " +
            moment(data.value).format("LT")
          }}
        </a>
      </template>
