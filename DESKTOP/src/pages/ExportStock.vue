  ...
  <q-page>
    <q-banner class="bg-primary text-orange">
      <div class="text-h6 orange">
        <span color="orange">Xuất tồn Kho thành phẩm</span>
      </div>
    </q-banner>
    <div>
      ...
      <div class="row" v-if="destination">
...
export default {
  data() {
    return {
      ...
      destination:null,
      destinations:[{
          label:'Xuất Container',
          id:100072
      },{
          label:'Chuyển YS lưu kho',
          id:102490
      }],
      metaValue: {
        kinhGui:
          ...
          await results.forEach((e) => {
            if (e.NAME) {
              this.resultData.push({
                ...
                nguonPhoi: e.NGUON_PHOI ? e.NGUON_PHOI : null,
                date: moment().utc(7).format(),
                month: moment().format("L").split("/")[1],
