      ...
      <q-card-section class="bg-primary">
        <div class="row">
          <div class="col-6 top-title text-orange">
            Báo cáo tổng hợp số lượng đã xác nhận xem thông báo
          </div>
...
export default {
  ...
  methods: {
    ...
    calculateNumberUnconfirm(rowData){
        rowData.numberUnconfirm = rowData.sumNumberConfirm - rowData.numberConfirm;
    ...
    async load() {
      ...
      const data = await this.$store.dispatch(
        "NOTIFY/COUNT_CONFIRM_INFORMATION",
        payload
      );
