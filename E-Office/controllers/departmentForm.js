...
module.exports = {
    ...
    show: async(req, res) => {
        ...
        try {
            let accountForm = await sequelize.query(
                `
            select * from base.DEPARTMENT d where d.NAME is not NULL `, { type: QueryTypes.SELECT }
            );
    ...
    getAll: async(req, res) => {
        ...
        try {
            let accountForm = await sequelize.query(
                `
            select * from base.DEPARTMENT where ID = ${req.query.id}`, { type: QueryTypes.SELECT }
            );
            result.data = accountForm;
        } catch (error) {
            console.log(error);
