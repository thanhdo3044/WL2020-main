...
import CalendarWorkOneDay from 'components/eofs/CalendarWork/CalendarWorkOneDay.vue'
import CalendarWorkThreeDay from 'components/eofs/CalendarWork/CalendarWorkThreeDay.vue'
import CalendarWorkWeek from 'components/eofs/CalendarWork/CalendarWorkWeek.vue'
import CalendarWorkMonth from 'components/eofs/CalendarWork/CalendarWorkMonth.vue'
export default {
  components:{
    CalendarWorkWeek,
    CalendarWorkOneDay,
