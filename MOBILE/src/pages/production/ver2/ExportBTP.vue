  ...
  <q-page class="q-pa-md">
    <div class="row justify-center">
      <div class="page-title">
        <div class="col-auto">Xuất phôi bán thành phẩm</div>
      </div>
    </div>
    <div class="row">
...
export default {
  ...
  data() {
    return {
      ...
      departments: [
          {
              label: "Tổ lựa phôi Outdoor (YS1A)",
              value: 102345
          },
          {
              label: "Tổ Lựa phôi Indoor (YS1A)",
              value: 102347
          },
              {
              label: "Tổ lựa phôi Indoor (TB)",
              value: 102370
          },
          {
              label: "Tổ lựa phôi Outdoor (TB)",
              value: 102378
          },
            {
              label: "Tổ Tinh chế 1 (YS1B)",
              value: 102356
          },
           {
              label: "Tổ Tinh chế 2 (YS1B)",
              value: 102357
          },
            {
              label: "Tổ Tinh chế 3 (YS1B)",
              value: 102530
          },
            {
              label: "Tổ Runnen (YS1A)",
              value: 102354
          },
             {
              label: "Nhóm Hoàn thiện VGT (YS1A)",
              value: 102447
          },
          {
              label: "Nhóm Hoàn thiện bề mặt (YS1B)",
              value: 102359
          },
           {
              label: "Nhóm lắp ráp mộc (YS1B)",
              value: 102360
          },
              {
              label: "Tổ sơ chế Outdoor (YS1B)",
              value: 102355
          },
          {
 ...
 this.$store.getters["base/mySources"].forEach((s) => {
  ...
  methods: {
    ...
    async showConfirmDialog() {
      this.card = true;
      this.ngay = '20210712'
      if (this.congdoan.value == 102488) this.ngay = '20211004'
      console.log('ngay',this.ngay)
    ...
    async onClick() {
      ...
      // } else
       if (this.quantity < 0) {
      ...
      } else if (!this.department || this.xuaton <= 0) {
        this.$q.dialog({
          title: "Lỗi",
        ...
        const payload = {
          ...
          nguonPhoi: this.nguonPhoi ? this.nguonPhoi.value : null,
          poNumber: this.group,
          destinationId: this.department.value,
