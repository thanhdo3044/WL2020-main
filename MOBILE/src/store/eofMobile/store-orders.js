...
const actions = {
    ...
    //     return data;
    // },
    // confirmComputerEquipment: async({ commit }, payload) => {
    //     console.log('đâs')
    //     let data = await client.put("/api/v2/orders/confirmComputerEquipment?id=" + payload.id + "&computerEquipment=" + payload.computerEquipment)
    //     return data;
    // },
