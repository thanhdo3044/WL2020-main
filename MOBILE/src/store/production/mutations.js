...
export function setDinhMucs(state, payload) {
  state.dinhMucs = payload;
}
export function setTyLeTHs(state, payload) {
  state.tyLeTHs = payload;
}
export function setTonTaiTos(state, payload) {
  state.tonTaiTos = payload;
}
