const conf = {
    database: {
        user: 'sa',
        password: '123456@a123456',
        server: '192.168.2.6',
        database: 'FB50_WL_App',
        port: parseInt(1300),
        // options: {
        //     appName: 'app',
        //     useUTC: false,
    ...
    database1: {
        user: process.env.VPDB_USER,
        password: process.env.VPDB_PASSWORD,
        server: process.env.VPDB_SERVER,
        database: process.env.VPDB_DATABASE,
        port: parseInt(process.env.VPDB_PORT || 1433),
    },
    msdb: {
